...
### 2.1.14 ###
* New: Dark mode support in the Gutenberg block editor
* New: "Show Tagline" option in Site Identity to display the site tagline below the header logo
* Multiple bug fixes and improvements

### 2.1.13 ###
* New: Header & Footer Builder (Lite) now available in the Customizer
* Multiple bug fixes and improvements
...
### 2.1.7 ###
* Add a notice to the Patterns section
...
### 2.1.4 ###
* Added Global Color Palettes in Customizer

### 2.1.3 ###
* Fixed missing nonce validation on some functions
* Minor fixes

### 2.1.2 ###
* New Remix Demo
* The Starter Content on new website is now optional in the Customizer
* Minor bug fixes
